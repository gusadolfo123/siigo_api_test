...
(function(root, factory) {
  ...
  describe('FixedAssetsApi', function() {
    describe('getAssetGroup', function() {
      it('should call getAssetGroup successfully', function(done) {
        //uncomment below and update the code to test getAssetGroup
        //instance.getAssetGroup(function(error) {
